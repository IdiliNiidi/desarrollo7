...
<OPTION values="texto"SELECTED>Descripcion
<OPTION values="titulo">Titulo
<OPTION value="categoria">Categoria
</SELECT>
con el valor
<input TYPE="text" NAME="valor">
<INPUT NAME="CosultarFiltro" VALUE="Filtrar Datos"TYPE="submit"/>
<INPUT NAME="CosultarTodos" VALUE="Ver todos" TYPE="submit"/>
</FORM>
    <?PHP
    ...
    if (array_key_exists('ConsultarFiltro', $_POST)){
      $obj_noticia= new noticia();
      $noticias = $obj_noticia->consultar_noticias_filtro($_REQUEST['campo'],$_REQUEST['valor']);
    }
